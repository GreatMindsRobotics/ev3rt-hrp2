...
#define APP_HEAP_SIZE    (1024 * 1024 * 4 * 4) //!< Heap size for dynamic memory allocation in TDOM_APP
...
#define TMAX_APP_DATA_SIZE   (1024 * 1024 * 4 * 4) //!< Maximum size of the data section in a loadable application module
